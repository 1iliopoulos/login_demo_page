...
Αυτή είναι μια απλή σελίδα σύνδεσης (login page) που δημιουργήθηκε για εκπαιδευτικούς σκοπούς. Το έργο χρησιμοποιεί HTML και CSS για την υλοποίηση μιας βασικής φόρμας σύνδεσης. 
...
Εκπαιδευτικούς Σκοπούς: Μαθαίνετε πώς να δημιουργείτε φόρμες σύνδεσης με HTML και CSS.
...
## Επικοινωνία
Για ερωτήσεις ή σχόλια, μπορείτε να ανοίξετε ένα issue στο GitHub repository ή να επικοινωνήσετε μαζί μας μέσω email (dpiliopoulos@gmail.com).
